...
public class OutflowConfig implements StepConfig {
    ...
    private float outflowStrength = 0.6f;
    private float minDelta = 0.01f; // permet d'eviter les recalculs constant de transfert entre des tiles avec une surface proche
